...
*     .. Parameters ..
      ...
      INTEGER          LDC, LDX
      PARAMETER        ( LDC = ( MMAX + NMAX + LMAX ), LDX = NMAX )
      INTEGER          LENGQ
      PARAMETER        ( LENGQ = 2*(MMAX + NMAX+LMAX)-1 )
      INTEGER          LIWORK
      PARAMETER        ( LIWORK = NMAX+2*LMAX )
      INTEGER          LDWORK
      PARAMETER        ( LDWORK = (2 + ( MMAX + NMAX+LMAX ) +
     $                            2*( MMAX + NMAX+LMAX ) +
     $                              ( MMAX + NMAX+LMAX ) +
     $                            ( ( NMAX+LMAX )*( NMAX+LMAX-1 )/2 +
     $                              MMAX*( NMAX+LMAX-( MMAX-1 )/2 ) ) +
     $                            ( 6*(NMAX+LMAX)-5 + LMAX*LMAX + NMAX
     $                            + LMAX + 3*LMAX ) ) )
      INTEGER          LBWORK
