...
*     .. Parameters ..
     ...
     $                   LDW3 = ( LDW1*( LDW1 + ( LDW1 + PVMAX ) +
     $                            5 ) + NMAX*( PMAX + 5 ) ),
     $                   LDW4 = ( LDW2*( LDW2 + ( LDW2 + MWMAX ) +
     $                            5 ) + NMAX*( MMAX + 5 ) ),
     $                   LDW5 = PVMAX*( NVMAX + PVMAX ) + PVMAX*NVMAX +
     $                          ( NVMAX*( NVMAX + 5 ) + 4*PVMAX +
     $                            PVMAX*( PVMAX + 2 ) + 4*PMAX ),
     $                   LDW6 = ( PMAX + PVMAX )*( 2*NVMAX +
     $                          ( PMAX + PVMAX ) ) +
     $                          ( LDW5 + NVMAX +
     $                                 ( NVMAX + 3*PMAX + 3*PVMAX )
     $                                       ),
     $                   LDW7 = ( NWMAX + ( NWMAX + 3*MMAX ) +
     $                          2*NWMAX*( MMAX + MWMAX ) +
     $                            NWMAX + ( NWMAX + 3*MMAX +
     $                                              3*MWMAX ) ),
     $                   LDW8 = MWMAX*( NWMAX + MWMAX ) +
     $                          ( NWMAX*( NWMAX + 5 ) + 4*MWMAX +
     $                            MWMAX*( MWMAX + 2 ) + 4*MMAX ) )
      PARAMETER        ( LDWORK = ( LDW6 + LDW7 + LDW8 +
     $                              2*NMAX*NMAX +
     $                              ( 1 + LDW3 + LDW4 +
     $                                    2*NMAX*NMAX + 5*NMAX +
     $                                     NMAX*( MMAX + PMAX ) ) )
