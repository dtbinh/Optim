...
*     .. Parameters ..
     ...
     $                    LIWORK = ( MMAX + LMAX + MMAX*NOBRMX + NMAX +
     $                               MMAX*( NMAX + LMAX ) ) )
     ...
     $                                2*NMAX + L0 ),
     $                    LXM  = BSNM*LMAX + LTHS,
     $                    L2M  =    ( LXM*LXM + 3*LXM + NSMPMX*LMAX ),
     $                    LDW1 =    ( 2*( LMAX*NOBRMX - LMAX )*NMAX +
     $                                2*NMAX +
     ...
     $                           ( NMAX + MMAX ) + NMAX +
     $                              ( 1 + NMAX*NMAX*LMAX + NMAX*LMAX +
     $                                NMAX + NMAX*NMAX +
     $                                   ( NMAX*NMAX +
     $                                     NMAX*   ( NMAX + LMAX ) +
     $                                     6*NMAX +      NMAX + LMAX +
     $                                     NMAX*MMAX ) ),
     $                    LDW7 =    ( BSNM*BSNM + 3*BSNM + NSMPMX ),
     $                    LDW8 = NSMPMX*LMAX + ( NMAX + LMAX )*
     $                           ( NMAX + MMAX ) + 3*NMAX + MMAX + LMAX,
     $                    LW1  =    ( 2*( MMAX + LMAX )*NOBRMX*
     ...
     $                                     LDW5 + LDW6 ) ),
     $                    LW2  = NSMPMX*LMAX +
     $                             ( 5 + NSMPMX + 2*BSNM + NSMPMX*BSNM +
     $                                      ( 2*NNMAX + BSNM + LDW7 ) ),
     $                    LW3  =    ( LDW8 + NSMPMX*LMAX +
     $                                ( NMAX + LMAX )*( 2*NMAX + MMAX )+
     $                                2*NMAX ),
     $                    LW4  =    ( 5 + NSMPMX*LMAX + 2*LXM +
     $                                NSMPMX*LMAX*( BSNM + LTHS ) +
     $                                 ( L1M + LXM + NSMPMX*LMAX + L1M +
     $                                   L2M ) ),
     $                    LDWORK =    ( LW1 + LW2 + LW3 + LW4 ) )
*     .. Local Scalars ..
