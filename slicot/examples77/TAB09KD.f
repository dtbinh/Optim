...
*     .. Parameters ..
     ...
     $                   LDD = PMAX, LDDV = PMAX,  LDDW = MMAX )
      INTEGER          LIWORK
      PARAMETER        ( LIWORK = 2*( MMAX + PMAX ) )
      INTEGER          LDW1, LDW2, LDW3, LDW4, LDWORK
      PARAMETER        ( LDW1 = ( NVMAX*( NVMAX + 5 ) + NVMAX*NMAX +
     $                          ( 2*NVMAX + PMAX*NMAX + PMAX*MMAX ) ))
      PARAMETER        ( LDW2 = ( NWMAX*( NWMAX + 5 ) + NWMAX*NMAX +
     $                          ( 2*NWMAX + MMAX*NMAX + PMAX*MMAX ) ))
