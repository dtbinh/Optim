...
C     and BF is Hermitian. The embedding doubles the multiplicities of
C     the eigenvalues of the pencil aS - bH.
...
C                        w2 = 6*N**2+MAX(2*N, 24)+3,
C                                        if COMPQ = 'C' or  COMPU = 'C';
C                        w2 = 3*N**2+MAX(2*N, 24)+3,
