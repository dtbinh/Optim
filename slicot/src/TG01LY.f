...
C     max(||E||,||A||) to detect negligible submatrices in A and E.
C
      SVLMAX = MAX( DLANGE( 'Frobenius-Norm', N, N, A, LDA, DWORK ),
     $              DLANTR( 'Frobenius-Norm', 'Upper', 'Non-Unit',
     $                      RANKE, RANKE, E, LDE, DWORK ) ) / DBLE( N )
C
...
C
         IF( DLANTR( 'Frobenius-Norm', 'Upper', 'Non-Unit', RO1, RO1,
