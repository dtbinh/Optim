...
C             indices, as well as of the corresponding diagonal blocks.
C             Specifically, a positive value is an index of a real
C             eigenvalue, corresponding to a 1-by-1 block pair, while
C             the absolute value of a negative entry in IWORK is an
C             index to the first eigenvalue in a pair of consecutively
C             stored eigenvalues, corresponding to a 2-by-2 block pair.
C
...
C     REVISIONS
C
C     V. Sima, July 2013, Aug. 2014, Jan. 2017.
C     M. Voigt, July 2013.
C
C     KEYWORDS
C
...
C
C     .. Local Scalars ..
      LOGICAL            LCMPQ, LINIQ, LQUERY, LTRI, LUPDQ, SING
...
C     .. External Functions ..
      ...
      EXTERNAL           DDOT, DLAMCH, DLANGE, DLANTR, LSAME, DLAPY2,
     $                   MA02ID, MA02OD
C
